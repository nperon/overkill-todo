...
var DialogOpeningButtonComponent = /** @class */ (function () {
    function DialogOpeningButtonComponent(dialog) {
        this.dialog = dialog;
    }
    DialogOpeningButtonComponent.prototype.ngOnInit = function () {
    };
    DialogOpeningButtonComponent.prototype.openDialog = function () {
        this.todoAddDialogRef = this.dialog.open(_todo_add_todo_add_component__WEBPACK_IMPORTED_MODULE_3__["TodoAddComponent"], null);
    };
    DialogOpeningButtonComponent.ctorParameters = function () { return [
    ...
    return DialogOpeningButtonComponent;
}());
...
var TodoAddComponent = /** @class */ (function () {
    function TodoAddComponent(formBuilder, store, dialogRef) {
    ...
    Object.defineProperty(TodoAddComponent.prototype, "f", {
 ...
 */
var TodosTableDataSource = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](TodosTableDataSource, _super);
    function TodosTableDataSource(todosStore) {
        var _this = _super.call(this) || this;
        _this.todosState = todosStore.select('todos');
        return _this;
    }
    /**
     ...
     */
    TodosTableDataSource.prototype.connect = function () {
     ...
     */
    TodosTableDataSource.prototype.disconnect = function () { };
    TodosTableDataSource.ctorParameters = function () { return [
        { type: _ngrx_store__WEBPACK_IMPORTED_MODULE_2__["Store"] }
    ]; };
    return TodosTableDataSource;
...
var TodosTableComponent = /** @class */ (function () {
    function TodosTableComponent(store) {
        this.store = store;
        /** Columns displayed in the table. Columns IDs can be added, removed, or reordered. */
        this.displayedColumns = ['title', 'done'];
    }
    TodosTableComponent.prototype.ngOnInit = function () {
    ...
    TodosTableComponent.prototype.ngAfterViewInit = function () {
        this.dataSource.sort = this.sort;
        this.dataSource.paginator = this.paginator;
        this.table.dataSource = this.dataSource;
    };
    TodosTableComponent.prototype.toggle = function (row, event) {
        var action = new _reducers_todos_effects__WEBPACK_IMPORTED_MODULE_7__["UpdateAndFetchTodoAction"](row.id, row.title, event.checked, row.description);
        this.store.dispatch(action);
    };
    TodosTableComponent.ctorParameters = function () { return [
...
var CLEAR_ALL_TODOS = 'CLEAR_ALL_TODOS';
var ToggleDoneAction = /** @class */ (function () {
    function ToggleDoneAction(id, value) {
        this.id = id;
        this.value = value;
        this.type = TOGGLE_DONE;
    }
    ToggleDoneAction.ctorParameters = function () { return [
        { type: Number },
        { type: Boolean }
    ]; };
    return ToggleDoneAction;
}());

var AddTodoAction = /** @class */ (function () {
    function AddTodoAction(id, title, value, description) {
        this.id = id;
        this.title = title;
        this.value = value;
...
var ClearAllTodosAction = /** @class */ (function () {
    function ClearAllTodosAction() {
        this.type = CLEAR_ALL_TODOS;
    }
    return ClearAllTodosAction;
}());
...
var UPDATE_AND_FETCH_TODO = 'UPDATE_AND_FETCH_TODO';
var CREATE_TODO = 'CREATE_TODO';
var FetchTodosAction = /** @class */ (function () {
...
var UpdateAndFetchTodoAction = /** @class */ (function () {
    function UpdateAndFetchTodoAction(id, title, done, description) {
        this.id = id;
        this.title = title;
        this.done = done;
        this.description = description;
    ...
    UpdateAndFetchTodoAction.ctorParameters = function () { return [
        { type: Number },
        { type: String },
        { type: Boolean },
        { type: String }
    ]; };
    return UpdateAndFetchTodoAction;
}());

var CreateTodoAction = /** @class */ (function () {
    function CreateTodoAction(title, done, description) {
        this.title = title;
        this.done = done;
        this.description = description;
        this.type = CREATE_TODO;
    }
    CreateTodoAction.ctorParameters = function () { return [
        { type: String },
        { type: Boolean },
        { type: String }
    ]; };
...
var TodosEffects = /** @class */ (function () {
    function TodosEffects(actions$, todosService) {
        var _this = this;
        this.actions$ = actions$;
        this.todosService = todosService;
        this.fetchTodos = this.actions$
            .pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(FETCH_TODOS), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (action) {
            var todosObs = _this.todosService.getTodos();
            return todosObs;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (data) {
            return data.reduce(function (builtUp, item) {
                return tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](builtUp, [
        ...
        this.updateTodo = this.actions$
            .pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(UPDATE_AND_FETCH_TODO), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["mergeMap"])(function (action) { return _this.todosService.updateTodo({ id: action.id, title: action.title, done: action.done, description: action.description }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function () { return new _todos_actions__WEBPACK_IMPORTED_MODULE_5__["ToggleDoneAction"](action.id, action.done); })); }));
        this.createTodo = this.actions$
            .pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(CREATE_TODO), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["mergeMap"])(function (action) { return _this.todosService.createTodo({ id: null, title: action.title, done: action.done, description: action.description }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (data) { return new _todos_actions__WEBPACK_IMPORTED_MODULE_5__["AddTodoAction"](data.id, data.title, false, data.description); })); }));
    }
    TodosEffects.ctorParameters = function () { return [
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _todos_actions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./todos.actions */ "./src/app/shared/reducers/todos.actions.ts");


function todosReducer(state, action) {
    if (state === void 0) { state = []; }
    switch (action.type) {
        case _todos_actions__WEBPACK_IMPORTED_MODULE_1__["ADD_TODO"]:
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](state, [
                { id: action.id, title: action.title, done: action.value, description: action.description }
            ]).sort(compare);
        case _todos_actions__WEBPACK_IMPORTED_MODULE_1__["TOGGLE_DONE"]:
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](state).map(function (item) {
                return item.id === action.id
                    ? tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, item, { done: action.value }) : tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, item);
            })
                .sort(compare);
        case _todos_actions__WEBPACK_IMPORTED_MODULE_1__["CLEAR_ALL_TODOS"]:
            return [];
        default:
            return state;
    }
...
var InMemoryDataService = /** @class */ (function () {
    ...
    InMemoryDataService.prototype.genId = function (todos) {
        return todos.length > 0 ? Math.max.apply(Math, tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](todos.map(function (todo) { return todo.id; }))) + 1 : 1;
    };
...
var TodoDetailComponent = /** @class */ (function () {
    function TodoDetailComponent(route, location, store) {
        this.route = route;
    ...
    TodoDetailComponent.prototype.ngOnInit = function () {
        ...
        this.subscription = this.todosObs.subscribe(function (data) {
            _this.todo = data.find(function (item) { return (item.id === id); });
        });
    };
